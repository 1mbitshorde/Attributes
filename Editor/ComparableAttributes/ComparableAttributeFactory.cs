    ...
    public static class ComparableAttributeFactory
    {
        public static IComparableAttribute Create(AbstractComparableAttribute attribute, SerializedProperty property)
        {
            return property.propertyType switch
            {
                ...
                SerializedPropertyType.ObjectReference => new ReferenceComparableAttribute(property.objectReferenceEntityIdValue, attribute.value),
                ...
                SerializedPropertyType.ExposedReference => new ReferenceComparableAttribute(property.exposedReferenceValue.GetEntityId(), attribute.value),
